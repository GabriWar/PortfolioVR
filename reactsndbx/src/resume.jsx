			...
			<div className="text">
				...
				{elements.linux && (
					<p>
						...
						<a href="https://github.com/GabriWar" className="link-color">
							Shell Scripting
						</a>{" "}
						and automation, adept at optimizing system performance and
						troubleshooting.
					</p>
				)}
				...
				{elements.edu && (
					<p>
						...
						expanding my knowledge and staying at theforefront of technology. I
